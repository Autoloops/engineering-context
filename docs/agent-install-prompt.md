...
greplica install --platform <codex|claude|copilot|opencode|cline|openhands|factory-droid|antigravity> --embedding local <mapped-hook-and-memory-flags>
```
...
```bash
greplica transcript bundle --platform <codex-or-claude-or-copilot-or-opencode-or-cline> --file <path-1> [--file <path-2>] [--file <path-3>] --out <greplica-transcript-backfill.md>
```
