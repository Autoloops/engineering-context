...
- For OpenCode and Cline, tell me transcript backfill is not supported yet.
...
- End with a short note that hooks, installed skills, or generated rules might need a restart or reload.
