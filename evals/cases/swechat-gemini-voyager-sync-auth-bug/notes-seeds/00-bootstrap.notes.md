...
- Smaller content modules are individually scoped under `src/pages/content/`: `chatWidth`, `editInputWidth`, `sidebarWidth`, `sidebarAutoHide`, `inputCollapse`, `sendBehavior`, `recentsHider`, `gemsHider`, `markdownPatcher`, `defaultModel`, `quoteReply`, `formulaCopy`, `mermaid`, `userLatex`, `preventAutoScroll`, `titleUpdater`, `visualEffects`, `katexConfig`, and `changelog`.
