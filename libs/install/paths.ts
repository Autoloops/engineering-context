...
export type InstallPlatform = "codex" | "claude" | "opencode" | "openhands" | "factory-droid" | "copilot" | "cline" | "antigravity";
export type InstallEmbedding = "local" | "openai";

export const installPlatforms = ["codex", "claude", "copilot", "opencode", "cline", "openhands", "factory-droid", "antigravity"] as const satisfies readonly InstallPlatform[];
